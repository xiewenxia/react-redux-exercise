...
componentDidMount(){
  // console.log(this.props)//通过connect传过来的comments和onSubmit
  // console.log(87878)
}
  render () {
    return (
...
// 将 store 中的数据作为 props 绑定到组件上,CommentInputContainer会有comment这个属性、
...
// 将 action 作为props 绑定到 MyComp 上。该onSubmit属性也会挂载到CommentInputContainer
...
//CommentInputContainer是 要添加prop的react组件
